  ...
  return (
    <div className="min-h-screen py-20 px-4 md:px-8">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-3xl font-bold text-[#D4D4E0] mb-2">Terms of Service</h1>
        ...
        <div className="space-y-8 text-sm text-[#9A9AB0] leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-[#D4D4E0] mb-3">1. Agreement to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#D4D4E0] mb-3">2. Description of Service</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#D4D4E0] mb-3">3. User Accounts</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#D4D4E0] mb-3">4. Subscriptions and Billing</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#D4D4E0] mb-3">5. Acceptable Use</h2>
            <p>You agree not to:</p>
            <ul className="list-disc list-inside mt-2 space-y-1 text-[#7A7A90]">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#D4D4E0] mb-3">6. Disclaimer of Warranties</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#D4D4E0] mb-3">7. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#D4D4E0] mb-3">8. Changes to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#D4D4E0] mb-3">9. Contact</h2>
            <p>
        ...
        <div className="mt-12 pt-8 border-t border-[#2A2A3A]/30">
          <p className="text-xs text-[#555570]">
            <Link href="/privacy" className="text-[#7A7A90] hover:text-[#D4D4E0]">Privacy Policy</Link>
            {' '}&middot;{' '}
