  ...
  return (
    <div className="space-y-6">
      ...
      <div className="animate-fade-up">
        ...
        <p className="text-sm text-[#555570] mt-1">RPM at speed for your drivetrain combo</p>
      </div>
      ...
      <div className="bg-[#14141F] border border-[#2A2A3A] rounded-lg p-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div>
            <label className="text-[10px] text-[#555570] uppercase block mb-1">Track Top Speed</label>
            <div className="flex items-center gap-1">
              <input
                type="number"
                ...
                className="w-full bg-[#1A1A28] border border-[#2A2A3A] rounded-md px-3 py-2.5 font-mono text-sm text-center focus:outline-none focus:ring-1 focus:ring-[#00B4FF] min-h-[44px]"
              />
              <span className="text-[10px] text-[#555570]">mph</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Engine RPM points */}
      <div className="bg-[#14141F] border border-[#2A2A3A] rounded-lg p-4">
        <p className="text-xs font-semibold text-[#7A7A90] uppercase tracking-wider mb-3">Engine Reference Points</p>
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="bg-[#14141F] border border-[#2A2A3A] rounded-lg p-3 text-center">
          ...
          <p className="text-[10px] text-[#555570]">rear &times; top gear</p>
        </div>
        {result.speedAtPeakTorque !== undefined && (
          <div className="bg-[#14141F] border border-[#2A2A3A] rounded-lg p-3 text-center">
            <p className="text-[10px] text-[#555570] uppercase">Peak TQ Speed</p>
            <p className="font-mono text-xl font-bold mt-1 text-[#00E676]">{result.speedAtPeakTorque} mph</p>
            <p className="text-[10px] text-[#555570]">in top gear</p>
          </div>
        )}
        {result.speedAtPeakHp !== undefined && (
          <div className="bg-[#14141F] border border-[#2A2A3A] rounded-lg p-3 text-center">
            <p className="text-[10px] text-[#555570] uppercase">Peak HP Speed</p>
      ...
      <div className="bg-[#14141F] border border-[#2A2A3A] rounded-lg overflow-hidden">
        ...
        <div className="px-4 py-2 border-t border-[#2A2A3A] flex gap-4 text-[10px]">
          ...
          <span className="flex items-center gap-1">
            <span className="w-2 h-2 rounded-full bg-[#00B4FF]" /> Peak HP Zone
          </span>
          <span className="flex items-center gap-1">
