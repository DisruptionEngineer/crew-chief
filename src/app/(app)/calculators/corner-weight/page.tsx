  ...
  return (
    <div className="space-y-6">
      ...
      <div className="animate-fade-up">
        ...
        <p className="text-sm text-[#555570] mt-1">Enter scale readings, get load bolt adjustments</p>
      </div>
            ...
            return (
              <div key={corner} className="bg-[#1A1A28] rounded-md p-3">
                ...
                <input
                  ...
                  className="w-full bg-[#14141F] border border-[#2A2A3A] rounded-md px-3 py-2.5 font-mono text-lg text-center focus:outline-none focus:ring-1 focus:ring-[#00B4FF] min-h-[44px]"
                />
              </div>
            )
          })}
      ...
      <div className="bg-[#14141F] border border-[#2A2A3A] rounded-lg p-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div>
            <label className="text-[10px] text-[#555570] uppercase block mb-1">Cross Weight %</label>
            <input
              type="number"
          ...
          <div>
            <label className="text-[10px] text-[#555570] uppercase block mb-1">Left %</label>
            <input
              type="number"
          ...
          <div>
            <label className="text-[10px] text-[#555570] uppercase block mb-1">Rear %</label>
            <input
              type="number"
        ...
        <div className="mt-2">
          <label className="text-[10px] text-[#555570] uppercase block mb-1">Lbs per Jack Bolt Turn</label>
          <input
            type="number"
            value={input.lbsPerTurn ?? 12}
            onChange={e => update('lbsPerTurn', parseFloat(e.target.value) || 12)}
            step={1}
            className="w-24 bg-[#1A1A28] border border-[#2A2A3A] rounded-md px-3 py-2 font-mono text-sm text-center focus:outline-none focus:ring-1 focus:ring-[#00B4FF]"
          />
        </div>
      </div>
