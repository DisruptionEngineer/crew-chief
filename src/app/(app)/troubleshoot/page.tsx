    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button onClick={handleReset} className="text-sm text-[#FFD600] min-h-[48px]">Start Over</button>
        </div>

        <div>
          <h1 className="text-2xl font-bold tracking-tight uppercase">{result.title}</h1>
          <p className="text-sm text-[#FFD600] mt-1">{result.subtitle}</p>
        </div>
            ...
            {result.adjustments.map((adj, i) => (
              <div key={i} className="bg-[#1A1A1A] border border-[#333] rounded-lg p-4">
                <div className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-7 h-7 rounded-full bg-[#FFD600]/20 text-[#FFD600] flex items-center justify-center text-sm font-bold">
                    {adj.priority}
                  </span>
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-[#FFD600] font-mono mt-1">{adj.amount}</p>
      ...
      <div className="space-y-3">
        {currentStep.options.map((option, i) => (
          <button
            ...
            className="w-full text-left bg-[#1A1A1A] border border-[#333] rounded-lg p-4 hover:border-[#FFD600]/30 transition-colors min-h-[72px]"
          >
...
function OptionIcon({ name }: { name: string }) {
  const iconMap: Record<string, React.ReactNode> = {
    'arrow-up-right': <svg className="w-5 h-5 text-[#FFD600]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><line x1="7" y1="17" x2="17" y2="7" /><polyline points="7 7 17 7 17 17" /></svg>,
    'rotate-ccw': <svg className="w-5 h-5 text-[#FFD600]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><polyline points="1 4 1 10 7 10" /><path d="M3.51 15a9 9 0 102.13-9.36L1 10" /></svg>,
    'zap-off': <svg className="w-5 h-5 text-[#FFD600]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><polyline points="12.41 6.75 13 2 10.57 4.92" /><polyline points="18.57 12.91 21 10 15.66 10" /><polyline points="8 8 3 14 12 14 11 22 16 16" /><line x1="1" y1="1" x2="23" y2="23" /></svg>,
    'shuffle': <svg className="w-5 h-5 text-[#FFD600]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><polyline points="16 3 21 3 21 8" /><line x1="4" y1="20" x2="21" y2="3" /><polyline points="21 16 21 21 16 21" /><line x1="15" y1="15" x2="21" y2="21" /><line x1="4" y1="4" x2="9" y2="9" /></svg>,
    'corner-down-right': <svg className="w-5 h-5 text-[#FFD600]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><polyline points="15 10 20 15 15 20" /><path d="M4 4v7a4 4 0 004 4h12" /></svg>,
    'corner-up-right': <svg className="w-5 h-5 text-[#FFD600]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><polyline points="15 14 20 9 15 4" /><path d="M4 20v-7a4 4 0 014-4h12" /></svg>,
    'circle': <svg className="w-5 h-5 text-[#FFD600]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><circle cx="12" cy="12" r="10" /></svg>,
    ...
    'sun': <svg className="w-5 h-5 text-[#FFD600]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><circle cx="12" cy="12" r="5" /><line x1="12" y1="1" x2="12" y2="3" /><line x1="12" y1="21" x2="12" y2="23" /><line x1="4.22" y1="4.22" x2="5.64" y2="5.64" /><line x1="18.36" y1="18.36" x2="19.78" y2="19.78" /><line x1="1" y1="12" x2="3" y2="12" /><line x1="21" y1="12" x2="23" y2="12" /><line x1="4.22" y1="19.78" x2="5.64" y2="18.36" /><line x1="18.36" y1="5.64" x2="19.78" y2="4.22" /></svg>,
